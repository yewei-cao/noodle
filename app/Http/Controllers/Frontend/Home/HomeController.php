...
//     	sweetalert_message()->adv(trans("front_home.newyear"),'info');
    	//images/home/delivery_food.png
    	
    	Mapper::map("-39.5357013","176.8484829",['zoom' => 16]);
    	
//     	$adv=[];
//     	$adv['title']="Notification";
//     	$adv['text']="We are close on Sunday Monday and Tuesday(24th to 26th) in this holiday.";
