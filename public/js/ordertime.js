...
.valid()}})}function o(t){var n=e("#order_time_select");n.empty(),e.each(t,function(t,r){var i=e("<option></option>"
).attr("value",r.Value).text(r.Text);n.append(i)})}function a(t,n){e(t).siblings(".inline-error").remove
(),e(t).inlineError(n)}e("#order_date_select").change(function(){e("#order_date_select").valid(),s(e("#store_number"
).val(),e(this).val())});var u=e("#order_form").validate({errorClass:"error",validClass:"validated",rules
...
parents(".field-container").addClass(r).removeClass(n)},errorPlacement:function(e,t){return!0}});return e
("#order_time_select").change(function(){e("#order_time_select").valid()}),e("#start-order-button").click
(function(){if(i===!0)e("#order_time_select").valid()==0&&a("#order_time_select",r.order_time.message
),e("#order_date_select").valid()==0&&a("#order_date_select",r.order_date.message);else{var t=[];e("#order_time_select"
