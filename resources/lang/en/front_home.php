...
|--------------------------------------------------------------------------
|
| The following language lines are used in Home Page throughout the system.
|
*/
		'home'=>'Home',
		'create'=>'Create',
		...
		'address_freedilivery'=>'But you can get a free delivery by order over $50 amount dishes in Taradale area.',
		...
		'quick_order_ext'=>'Quickly reorder one of your recent orders',
		...
		'paymentmethod'=>['cash'=>'CASH','payinstore'=>'Pay in Store','credit'=>'CREDIT CARD','poli'=>'POLi(Internet Banking)'],
		...
		'policonfirm_title'=>'PLEASE CONFIRM YOUR POLI PAYMENT SELECTION',
		'credit_title'=>'PLEASE ENTER YOUR CREDIT CARD DETAILS',
		
		'place_order'=>'PLACE ORDER',
		
		'qorder_text1'=>'Sorry! We can\'t find any previous orders.',
