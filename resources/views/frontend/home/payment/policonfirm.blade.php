...
<div class="order-layout-left" style="min-height: 588px;" >
	...
	<div id="product_menu_container" class="order-layout-left-inner">
		...
		<div class="payment_confirm" >
			<h3 class="header lighter smaller text-center">{{ trans('front_home.policonfirm_title') }}</h3>
			...
			<div class="row">
				{!! Form::open(['method'=>'POST','action'=>'Frontend\Home\Payment\poliController@poli'])!!}
