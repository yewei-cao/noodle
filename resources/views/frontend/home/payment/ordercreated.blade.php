@extends('frontend.master') @section('css.style') @section('title') {{
			...
			<div class="widget-box transparent">
				<div class="widget-header widget-header-large">
					...
					<div class="widget-toolbar no-border invoice-info">
						<span class="invoice-info-label">Order number:</span> <span
							class="red_span">{{ $order->ordernumber}}</span> <br> <span
							class="invoice-info-label">Date:</span> <span class="blue">{{
				...
				<div class="widget-body">
					<div class="widget-main padding-24">
						...
						<div class="row">
								...
								<div>
									<ul class="list-unstyled spaced">
										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>Address:{{$shop->address}}</li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>Zip Code 4112</li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span> Hawkes Bay, New Zealand</li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span> Phone: <b class="red_span">06-844-3588</b></li>

										<li class="divider"></li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span> Paymant Info</li>
									</ul>
								</div>
							</div>
							<!-- /.col -->
							...
							<div class="col-sm-6">
								...
								<div>
									<ul class="list-unstyled  spaced">
										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>Name: {{ $order->name }}</li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>Phone: {{ $order->phonenumber }}</li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>Email: {{ $order->email }}</li>

										@if($order->address()->count())
										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>Address: {{
											$order->address->address }}</li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>Suburb: {{ $order->address->suburb
											}}</li>

										<li><span class="glyphicon glyphicon-triangle-right"
											aria-hidden="true"></span>City: {{ $order->address->city }}</li>
						...
						<div class="row border_bottom">
							<div class="pull-left ">Thank you for choosing Noodle Dishes. We
...
@endsection @section('scripts.footer')
