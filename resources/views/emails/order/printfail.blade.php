							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b>This Order print fail, please check in the backend. Order number : {{$order->ordernumber}}</b>
									</td>
								</tr>
								
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b>This Order print fail, please check in the backend. Order number : {{$num}}</b>
									</td>
								</tr>
